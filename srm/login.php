...
<div class="login">
<div class="head">
    <a class="form-title signin" href="login.php">LOGIN</a>
    <a class="form-title signup" href="register.php">REGISTER</a>
    </div>
    
    
    <div class="content">
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">        <div class="user-details">
